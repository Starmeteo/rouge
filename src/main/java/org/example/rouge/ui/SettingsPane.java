...
public class SettingsPane extends VBox {
     ...
     */
    public SettingsPane(Settings settings, Runnable onBack) {
        ...
        seedField.setPromptText("留空 = 每次随机（开发模式，用于复现地图，FR-19）");
        ...
        Label hint = new Label("提示：灵敏度将在战斗系统（第 3 天）、音量将在音频（第 8 天）、" +
                "种子将在地图生成（第 4 天）接入后生效，更多设置项将持续完善。");
        hint.getStyleClass().add("hint-text");

        getChildren().addAll(title, sensitivityRow, sfxRow, musicRow, seedRow, buttonRow, hint);
    }
