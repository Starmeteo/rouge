 ...
 *
 * <p>各项设置接入计划（对应需求与开发计划）：
 * <ul>
 *   <li><b>鼠标灵敏度</b> —— 第 3 天战斗系统接入瞄准计算（需求 §8 鼠标灵敏度可调）；</li>
 *   <li><b>音效 / 音乐音量</b> —— 第 8 天音频系统接入（FR-16）；</li>
 *   <li><b>开发随机种子</b> —— 第 4 天地图生成接入（FR-19 随机种子输入用于复现）；</li>
...
public class Settings {
    ...
    /** 开发模式随机种子（空字符串表示每次随机；第 4 天地图生成接入，FR-19） */
